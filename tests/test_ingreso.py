...
def test_el_costo_del_par_lo_domina_el_minimo_en_lo_chileno():
    # 0,1785% de $459.200 son $820, así que manda el mínimo de $1.990, dos veces.
    assert costo_del_par(459_200., .001785, 1990.) == 3980.
...
def test_una_salida_con_fecha_muestra_su_costo_anualizado():
    """Es el punto: el mismo 0,8% no cuesta lo mismo a nueve semanas que a diez meses."""
    ...
    assert "4,3% anual" in markdown(t, AS_OF)
